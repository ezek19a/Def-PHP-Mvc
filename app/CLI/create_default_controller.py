...
userinput = input('Please Enter Default Controller & Filename!: ')
...
content = """<div style="margin-top:42vh"><center><h1>Hi! This is the Default Setting!</h1></center></div>"""
...
class App{	
	...
	protected $controller = '"""+userinput+"""';
