...
while True:
    if not isExist:
        directory = input('The directory \"'+directory +'\" does not exist please enter the existing directory name.!: ')      
        root = '../views/'
        path = root+directory
        isExist = os.path.exists(path)
        continue
...
g = open('../views/'+directory+'/'+filename,'w')
...
message = """<?php
    ...
    class """ + classinput + """ extends Controller{
        ...
        public function index(){
            ...
            //$data['mhs'] = $this->model('"""+classinput+"""_model')->getAllData();
            $this->view('templates/header', $data);            
            $this->view('"""+directory+"""/"""+userinput+"""', $data);
	...
	public function curlApi(){
        ...
        public function detail($id){
            ...
            $this->view('templates/header', $data);
            $this->view('"""+directory+"""/detail', $data);
            $this->view('templates/footer');
